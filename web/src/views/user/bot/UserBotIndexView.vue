...
export default {
    ...
    setup() {        
        ...
        const refresh_bots = () => {//刷新bot列表
            $.ajax({
                url: "https://app5596.acapp.acwing.com.cn/api/user/bot/getlist/",
                type: "get",
                headers: {
        ...
        const add_bot = () => {
            ...
            $.ajax({
                url: "https://app5596.acapp.acwing.com.cn/api/user/bot/add/",
                type: "post",
                data: {
                    title: botadd.title,
                ...
                success(resp) {
                    if (resp.error_message === "success") {
                        ...
                        botadd.description = "";
                        botadd.content = "";
                        Modal.getInstance("#add-bot-btn").hide();//创建完成后关闭模态框
                        refresh_bots();
                    } else {
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url: "https://app5596.acapp.acwing.com.cn/api/user/bot/remove/",
                type: "post",
                data: {
                    bot_id: bot.id,
                },
        ...
        const update_bot = (bot) => {
            bot.error_message = "";
            $.ajax({
                url: "https://app5596.acapp.acwing.com.cn/api/user/bot/update/",
                type: "post",
                data: {
                    bot_id: bot.id,
                    title: bot.title,
                ...
                success(resp) {
                    //console.log(resp);
                    if (resp.error_message === "success") {
                        //Modal.getInstance("#update-bot-madal-" + bot.id).hide();//创建完成后关闭模态框
